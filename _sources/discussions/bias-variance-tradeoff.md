...
1.	A model with 95% predictive accuracy (on test data) identifies which students will fail a class, but none of the predictors are interpretable (e.g., a neural network using Canvas click behavior). A second model explains performance using sleep, study time, and prior GPA, but predicts worse. Which model is 'better science' and why? What are the caveats and implications of either?
